 ...
 */
public class admin_New_Bird extends javax.swing.JFrame {
    ...
    /**
     * Creates new form admin_New_Bird
     */
    public admin_New_Bird() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(622, 540));
    ...
    if(
        ...
        admin_addBird_Error lf = new admin_addBird_Error();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_New_Bird.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_New_Bird().setVisible(true);
            }
        });
    }
