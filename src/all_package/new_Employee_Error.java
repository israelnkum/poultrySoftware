 ...
 */
public class new_Employee_Error extends javax.swing.JFrame {

    /**
     * Creates new form new_Employee_Error
     */
    public new_Employee_Error() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Attention_100px.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(496, 175));
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(new_Employee_Error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new new_Employee_Error().setVisible(true);
            }
        });
    }
